...
**JavaScript**
``` JavaScript
PixelCombats.Api.RoomServer.Services.Properties.IProperty = function();
PixelCombats.Api.RoomServer.Services.Properties.IProperty.createInterface('PixelCombats.Api.RoomServer.Services.Properties.IProperty');
```
