...
**C#**
``` C#
IApiProp<bool, IInventoryContext> BuildInfinity { get; }
```
**VB**
``` VB
ReadOnly Property BuildInfinity As IApiProp(Of Boolean, IInventoryContext)
	Get
```
**C++**
``` C++
property IApiProp<bool, IInventoryContext^>^ BuildInfinity {
	IApiProp<bool, IInventoryContext^>^ get ();
}
```
**F#**
``` F#
abstract BuildInfinity : IApiProp<bool, IInventoryContext> with get
```
