...
**JavaScript**
``` JavaScript
PixelCombats.Api.RoomServer.Services.Inventory.IInventoryContext = function();
PixelCombats.Api.RoomServer.Services.Inventory.IInventoryContext.createInterface('PixelCombats.Api.RoomServer.Services.Inventory.IInventoryContext');
```
