# ChangeCameraPointsEnable - свойство
...
**VB**
``` VB
ReadOnly Property ChangeCameraPointsEnable As IApiProp(Of Boolean, IBuildContext)
	Get
```
**C++**
``` C++
property IApiProp<bool, IBuildContext^>^ ChangeCameraPointsEnable {
	IApiProp<bool, IBuildContext^>^ get ();
}
```
**F#**
``` F#
abstract ChangeCameraPointsEnable : IApiProp<bool, IBuildContext> with get
```
