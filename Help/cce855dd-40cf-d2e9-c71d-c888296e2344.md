...
**JavaScript**
``` JavaScript
PixelCombats.Api.RoomServer.Services.Damage.IDamageContext = function();
PixelCombats.Api.RoomServer.Services.Damage.IDamageContext.createInterface('PixelCombats.Api.RoomServer.Services.Damage.IDamageContext');
```
