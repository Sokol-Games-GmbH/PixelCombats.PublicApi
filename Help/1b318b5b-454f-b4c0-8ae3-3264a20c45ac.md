...
**VB**
``` VB
Public Interface IRoomInventoryContext
	Inherits IInventoryContext
```
**C++**
``` C++
public interface class IRoomInventoryContext : IInventoryContext
```
**F#**
``` F#
type IRoomInventoryContext = 
    interface
