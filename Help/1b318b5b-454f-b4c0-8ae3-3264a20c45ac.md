# IRoomInventoryContext - интерфейс
...
**JavaScript**
``` JavaScript
PixelCombats.Api.RoomServer.Services.Inventory.IRoomInventoryContext = function();
PixelCombats.Api.RoomServer.Services.Inventory.IRoomInventoryContext.createInterface('PixelCombats.Api.RoomServer.Services.Inventory.IRoomInventoryContext');
```

<table><tr><td><strong>Implements</strong></td><td><a href="ff635c4c-8cb1-6876-f351-b8eb44ea6ae9">IInventoryContext</a></td></tr>
</table>
