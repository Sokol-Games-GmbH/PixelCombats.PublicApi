...
**JavaScript**
``` JavaScript
PixelCombats.Api.RoomServer.Services.Inventory.IPlayerInventoryContext = function();
PixelCombats.Api.RoomServer.Services.Inventory.IPlayerInventoryContext.createInterface('PixelCombats.Api.RoomServer.Services.Inventory.IPlayerInventoryContext');
```
