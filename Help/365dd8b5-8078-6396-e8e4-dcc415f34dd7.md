...
\[&lt;returns&gt; отсутствует в документации для "M:PixelCombats.Api.RoomServer.Services.Areas.IRangesSet.Remove(PixelCombats.Api.Basic.Structures.Math.IndexRange)"\]
