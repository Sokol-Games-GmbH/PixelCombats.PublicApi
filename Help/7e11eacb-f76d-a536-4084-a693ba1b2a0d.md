...
**JavaScript**
``` JavaScript
PixelCombats.Api.RoomServer.Services.PropertiesContexted.ITeamContextedProperty = function();
PixelCombats.Api.RoomServer.Services.PropertiesContexted.ITeamContextedProperty.createInterface('PixelCombats.Api.RoomServer.Services.PropertiesContexted.ITeamContextedProperty');
```
