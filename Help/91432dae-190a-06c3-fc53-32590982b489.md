...
**C#**
``` C#
IApiProp<bool, IInventoryContext> Build { get; }
```
**VB**
``` VB
ReadOnly Property Build As IApiProp(Of Boolean, IInventoryContext)
	Get
```
**C++**
``` C++
property IApiProp<bool, IInventoryContext^>^ Build {
	IApiProp<bool, IInventoryContext^>^ get ();
}
```
**F#**
``` F#
abstract Build : IApiProp<bool, IInventoryContext> with get
```
