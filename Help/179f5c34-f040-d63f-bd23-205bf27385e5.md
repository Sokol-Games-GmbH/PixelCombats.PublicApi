...
**C#**
``` C#
public interface ITeamDamageContext : IDamageContext, 
	ITeamContext
```
**VB**
``` VB
Public Interface ITeamDamageContext
	Inherits IDamageContext, ITeamContext
```
**C++**
``` C++
public interface class ITeamDamageContext : IDamageContext, 
	ITeamContext
```
**F#**
``` F#
type ITeamDamageContext = 
    interface
