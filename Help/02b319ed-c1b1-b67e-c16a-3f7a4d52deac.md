...
**JavaScript**
``` JavaScript
PixelCombats.Api.RoomServer.Services.DefaultPropertiesContexted.IContextedPropertiesService = function();
PixelCombats.Api.RoomServer.Services.DefaultPropertiesContexted.IContextedPropertiesService.createInterface('PixelCombats.Api.RoomServer.Services.DefaultPropertiesContexted.IContextedPropertiesService');
```
