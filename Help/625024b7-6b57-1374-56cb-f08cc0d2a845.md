...
**C#**
``` C#
public interface ITeamTimersContext : ITimersContext, 
	IEnumerable<ITimerApi>, IEnumerable, ITeamContext, ITimerEvents
```
**VB**
``` VB
Public Interface ITeamTimersContext
	Inherits ITimersContext, IEnumerable(Of ITimerApi), IEnumerable, 
	ITeamContext, ITimerEvents
```
**C++**
``` C++
public interface class ITeamTimersContext : ITimersContext, 
	IEnumerable<ITimerApi^>, IEnumerable, ITeamContext, ITimerEvents
```
**F#**
``` F#
type ITeamTimersContext = 
    interface
