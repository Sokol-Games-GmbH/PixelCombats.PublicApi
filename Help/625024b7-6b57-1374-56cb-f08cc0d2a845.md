...
**JavaScript**
``` JavaScript
PixelCombats.Api.RoomServer.Services.Timers.ITeamTimersContext = function();
PixelCombats.Api.RoomServer.Services.Timers.ITeamTimersContext.createInterface('PixelCombats.Api.RoomServer.Services.Timers.ITeamTimersContext');
```
