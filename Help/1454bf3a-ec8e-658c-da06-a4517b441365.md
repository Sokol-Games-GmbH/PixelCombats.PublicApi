...
**JavaScript**
``` JavaScript
PixelCombats.Api.RoomServer.Services.Build.IRoomBuildContext = function();
PixelCombats.Api.RoomServer.Services.Build.IRoomBuildContext.createInterface('PixelCombats.Api.RoomServer.Services.Build.IRoomBuildContext');
```
