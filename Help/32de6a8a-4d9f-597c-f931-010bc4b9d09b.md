...
**C#**
``` C#
IApiProp<bool, IInventoryContext> Main { get; }
```
**VB**
``` VB
ReadOnly Property Main As IApiProp(Of Boolean, IInventoryContext)
	Get
```
**C++**
``` C++
property IApiProp<bool, IInventoryContext^>^ Main {
	IApiProp<bool, IInventoryContext^>^ get ();
}
```
**F#**
``` F#
abstract Main : IApiProp<bool, IInventoryContext> with get
```
