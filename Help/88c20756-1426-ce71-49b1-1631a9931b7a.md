# IRoomAreaViewContext - интерфейс
...
**JavaScript**
``` JavaScript
PixelCombats.Api.RoomServer.Services.Areas.View.IRoomAreaViewContext = function();
PixelCombats.Api.RoomServer.Services.Areas.View.IRoomAreaViewContext.createInterface('PixelCombats.Api.RoomServer.Services.Areas.View.IRoomAreaViewContext');
```
