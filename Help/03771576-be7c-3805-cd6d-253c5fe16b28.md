...
**C#**
``` C#
IApiProp<bool, IInventoryContext> MainInfinity { get; }
```
**VB**
``` VB
ReadOnly Property MainInfinity As IApiProp(Of Boolean, IInventoryContext)
	Get
```
**C++**
``` C++
property IApiProp<bool, IInventoryContext^>^ MainInfinity {
	IApiProp<bool, IInventoryContext^>^ get ();
}
```
**F#**
``` F#
abstract MainInfinity : IApiProp<bool, IInventoryContext> with get
```
