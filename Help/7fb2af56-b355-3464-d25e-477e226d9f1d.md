# IPlayerDamageContext - интерфейс
...
**JavaScript**
``` JavaScript
PixelCombats.Api.RoomServer.Services.Damage.IPlayerDamageContext = function();
PixelCombats.Api.RoomServer.Services.Damage.IPlayerDamageContext.createInterface('PixelCombats.Api.RoomServer.Services.Damage.IPlayerDamageContext');
```
