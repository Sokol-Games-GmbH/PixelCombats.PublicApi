...
**JavaScript**
``` JavaScript
PixelCombats.Api.RoomServer.Services.Damage.IRoomDamageContext = function();
PixelCombats.Api.RoomServer.Services.Damage.IRoomDamageContext.createInterface('PixelCombats.Api.RoomServer.Services.Damage.IRoomDamageContext');
```
