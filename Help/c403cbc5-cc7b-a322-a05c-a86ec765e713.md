...
**JavaScript**
``` JavaScript
PixelCombats.Api.RoomServer.Services.Build.IBuildContext = function();
PixelCombats.Api.RoomServer.Services.Build.IBuildContext.createInterface('PixelCombats.Api.RoomServer.Services.Build.IBuildContext');
```
