...
**JavaScript**
``` JavaScript
PixelCombats.Api.RoomServer.Services.PropertiesContexted.IPlayerContextedProperty = function();
PixelCombats.Api.RoomServer.Services.PropertiesContexted.IPlayerContextedProperty.createInterface('PixelCombats.Api.RoomServer.Services.PropertiesContexted.IPlayerContextedProperty');
```
