...
**JavaScript**
``` JavaScript
PixelCombats.Api.RoomServer.Services.Ui.ITeamUIContext = function();
PixelCombats.Api.RoomServer.Services.Ui.ITeamUIContext.createInterface('PixelCombats.Api.RoomServer.Services.Ui.ITeamUIContext');
```
