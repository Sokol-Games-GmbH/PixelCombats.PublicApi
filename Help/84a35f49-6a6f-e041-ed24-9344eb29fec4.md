# ITeamInventoryContext - интерфейс
...
**C#**
``` C#
public interface ITeamInventoryContext : IInventoryContext, 
	ITeamContext
```
**VB**
``` VB
Public Interface ITeamInventoryContext
	Inherits IInventoryContext, ITeamContext
```
**C++**
``` C++
public interface class ITeamInventoryContext : IInventoryContext, 
	ITeamContext
```
**F#**
``` F#
type ITeamInventoryContext = 
    interface
