# GameModeParameterIntValue - класс


\[&lt;summary&gt; отсутствует в документации для "T:PixelCombats.DTO.Room.GameMode.GameModeParameterIntValue"\]
...
public class GameModeParameterIntValue
```
**VB**
``` VB
<SerializableAttribute>
...
``` C++
[SerializableAttribute]
public ref class GameModeParameterIntValue
```
**F#**
``` F#
[<SerializableAttribute>]
type GameModeParameterIntValue = class end
```

<table><tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  GameModeParameterIntValue</td></tr>
</table>
...
<table>
<tr>
<td><a href="8b1cf417-f74e-df7c-894e-5321365aaf71">GameModeParameterIntValue</a></td>
<td>Инициализирует новый экземпляр класса GameModeParameterIntValue</td></tr>
</table>
