...
если истина, то карта содержит зону для конца паркура
...
**C#**
``` C#
public bool? HasParcourEnd
```
**VB**
``` VB
Public HasParcourEnd As Boolean?
```
**C++**
``` C++
public:
Nullable<bool> HasParcourEnd
```
**F#**
``` F#
val mutable HasParcourEnd: Nullable<bool>
```
