...
**VB**
``` VB
ReadOnly Property Immortality As IProperty(Of Boolean)
	Get
```
**C++**
``` C++
property IProperty<bool>^ Immortality {
	IProperty<bool>^ get ();
}
```
**F#**
``` F#
abstract Immortality : IProperty<bool> with get
```
