...
**C#**
``` C#
public interface ITeamBuildContext : ITeamContext, 
	IBuildContext
```
**VB**
``` VB
Public Interface ITeamBuildContext
	Inherits ITeamContext, IBuildContext
```
**C++**
``` C++
public interface class ITeamBuildContext : ITeamContext, 
	IBuildContext
```
**F#**
``` F#
type ITeamBuildContext = 
    interface
