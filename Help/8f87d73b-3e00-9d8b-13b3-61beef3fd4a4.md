...
**JavaScript**
``` JavaScript
PixelCombats.Api.RoomServer.Services.Properties.ITeamPropertiesContext = function();
PixelCombats.Api.RoomServer.Services.Properties.ITeamPropertiesContext.createInterface('PixelCombats.Api.RoomServer.Services.Properties.ITeamPropertiesContext');
```
