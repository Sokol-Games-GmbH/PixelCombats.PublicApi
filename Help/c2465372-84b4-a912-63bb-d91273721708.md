...
**JavaScript**
``` JavaScript
PixelCombats.Api.RoomServer.Services.Timers.IRoomTimerApi = function();
PixelCombats.Api.RoomServer.Services.Timers.IRoomTimerApi.createInterface('PixelCombats.Api.RoomServer.Services.Timers.IRoomTimerApi');
```
