...
**JavaScript**
``` JavaScript
PixelCombats.Api.RoomServer.Services.Timers.ITimerEvents = function();
PixelCombats.Api.RoomServer.Services.Timers.ITimerEvents.createInterface('PixelCombats.Api.RoomServer.Services.Timers.ITimerEvents');
```
