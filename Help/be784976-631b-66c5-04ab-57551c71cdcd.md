...
**C#**
``` C#
public interface IPlayerTimerApi : ITimerApi, 
	ITimerEvents, IPlayerContext
```
**VB**
``` VB
Public Interface IPlayerTimerApi
	Inherits ITimerApi, ITimerEvents, IPlayerContext
```
**C++**
``` C++
public interface class IPlayerTimerApi : ITimerApi, 
	ITimerEvents, IPlayerContext
```
**F#**
``` F#
type IPlayerTimerApi = 
    interface
        interface ITimerApi
