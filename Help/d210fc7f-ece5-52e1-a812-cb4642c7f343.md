...
**JavaScript**
``` JavaScript
PixelCombats.Api.RoomServer.Services.Build.IPlayerBuildContext = function();
PixelCombats.Api.RoomServer.Services.Build.IPlayerBuildContext.createInterface('PixelCombats.Api.RoomServer.Services.Build.IPlayerBuildContext');
```
