# IPlayerTimersContext - интерфейс
...
**JavaScript**
``` JavaScript
PixelCombats.Api.RoomServer.Services.Timers.IPlayerTimersContext = function();
PixelCombats.Api.RoomServer.Services.Timers.IPlayerTimersContext.createInterface('PixelCombats.Api.RoomServer.Services.Timers.IPlayerTimersContext');
```
