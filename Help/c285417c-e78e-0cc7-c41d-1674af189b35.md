...
**C#**
``` C#
IApiProp<bool, IInventoryContext> Melee { get; }
```
**VB**
``` VB
ReadOnly Property Melee As IApiProp(Of Boolean, IInventoryContext)
	Get
```
**C++**
``` C++
property IApiProp<bool, IInventoryContext^>^ Melee {
	IApiProp<bool, IInventoryContext^>^ get ();
}
```
**F#**
``` F#
abstract Melee : IApiProp<bool, IInventoryContext> with get
```
