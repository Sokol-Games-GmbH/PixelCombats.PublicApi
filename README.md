# АПИ 2.0 :warning:
## :warning: Уже тестируем - владельцев своих режимов просим поправить на новый АПИ, пока все в тесте. Позже выложим на всех и старые режимы работать перестанут.
